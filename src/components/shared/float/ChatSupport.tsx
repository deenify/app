...
// import { handleFocusIn } from "@/components/layout/marketing/footer/content"
    ...
    return (
        ...
        >
            ...
            <PopoverContent
                ...
                className={cn(
                    "w-[min(92vw,24rem)] max-w-[24rem] rounded-[1.5rem] border overflow-hidden",
                    "border-gray-200 bg-white shadow-[0_24px_80px_-30px_rgba(15,23,42,0.12)] p-0"
                )}
            >
                <div
                    className="transition-transform duration-200 ease-out">
                    <div className="flex min-h-[24rem] max-h-[inherit] flex-col overflow-hidden">
                     ...
                     border-gray-200 bg-white px-4 py-4">
                            ...
                            <Button
                                ...
                                size="icon"
                                shouldScale
                                className="h-7 w-7 shrink-0 rounded-md border border-emerald-200 bg-emerald-50 text-emerald-800"
                                onClick={onClose}
                        ...
                        <div
                            ref={composerRef}
                            className="border-t border-gray-200 bg-white px-3 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))]"
                        >
