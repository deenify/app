...
const GuidesBookmarksTabSection = ({
    ...
    if (guides.length === 0) {
        ...
        return (
            <section className="min-h-[45dvh] border-t border-gray-100 bg-[linear-gradient(180deg,#fafafa_0%,#f5f5f5_100%)] pb-10">
    ...
    return (
        <section className="h-max min-h-[45dvh] border-t border-gray-100 bg-[linear-gradient(180deg,#fafafa_0%,#f5f5f5_100%)] pb-10">
            <div className="container px-4 sm:px-6 md:px-6">
