            ...
            <header className="relative overflow-hidden border-b border-gray-100 bg-marketing-light">
                ...
                <div className="relative container py-10 xs:py-12 sm:py-16 lg:py-24">
                    ...
                    <Animate variant="up" delay={0.22} duration={0.75}>
                        <h1 className="marketing-section-heading">
                            {doc.title}{" "}
                    ...
                    <Animate variant="up" delay={0.44} duration={0.75}>
                        <div className="mt-6 flex flex-wrap items-center gap-x-4 gap-y-2 border-t border-gray-200/80 pt-4 text-xs text-gray-500 sm:mt-8 sm:gap-x-5 sm:pt-8 sm:text-sm">
