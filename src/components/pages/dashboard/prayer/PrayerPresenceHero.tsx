        ...
        text-white shadow-[0_24px_64px_rgba(0,0,0,0.22)]...">
            ...
            <div className="relative px-5 py-8 lg:p-6">
                    ...
                    <section className="flex w-full min-w-0 md:justify-end">
                        ...
                        >
                            ...
                            <div>
                                ...
                                tracking-tight sm:mt-3 sm:text-[1.65rem]">
                                    {DEMO_COUNTDOWN}
                                </p>
                ...
                <div className="grid grid-cols-2 gap-2 pt-4 sm:gap-2.5 sm:pt-5 lg:grid-cols-4 lg:gap-2.5 lg:pt-5">
                    {presenseHeroStatContent.map((stat) => {
                        ...
                        return (
                            <div
                                key={stat.label}
                                className="flex items-start justify-between gap-2 rounded-md border 
                                border-white/[0.08] bg-[#323232]/70 px-2.5 py-2 backdrop-blur-sm 
                                sm:px-3 sm:py-2.5"
                            >
                                ...
                                justify-center rounded-lg bg-white/[0.08]"
                                >
                ...
                <div className="mt-3 flex flex-wrap gap-1.5 sm:gap-2">
                    <Badge
                        variant="outline"
                        className="rounded-full border-none bg-white/[0.06] px-2.5 py-1 text-[11px] 
                        font-normal text-white/70 ring-1 ring-white/15 backdrop-blur-sm sm:px-3"
                    >
