                    ...
                    >
                        ...
                        <Animate variant="up" delay={0.34} duration={0.7}>
                            <Button
                                ...
                                className="mt-6 w-full max-w-xs rounded-md sm:rounded-full"
                                onClick={() => setSubmitted(false)}
                            >
                                Try another email
                            </Button>
                        </Animate>
                        <Animate variant="up" delay={0.42} duration={0.7}>
                            <p className="mt-5 text-sm leading-snug text-gray-600">
                                Or{" "}
                                <Button
                                    href="/login"
                                    variant="link"
                    ...
                    >
                        ...
                        <Animate variant="up" delay={0.28} duration={0.68}>
                            <p className="max-w-md text-pretty text-sm leading-normal text-gray-600 sm:max-w-lg sm:text-[15px] hidden sm:block">
                                Tell us your email and we will send instructions to reset your password safely.
                            </p>
