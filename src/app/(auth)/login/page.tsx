...
import { HIGHLIGHTS } from "@/components/pages/auth/content"
...
export default function LoginPage() {
    return (
        <section className="relative flex w-full flex-1 flex-col items-center justify-center py-5 xs:py-6 sm:py-8 lg:py-10">
            ...
            {/* Content  */}
            <main className="relative mx-auto w-full max-w-xl px-3 xs:px-4 sm:px-5 md:px-6 lg:max-w-5xl lg:px-8">

                <Card
                    className="flex w-full flex-col gap-5 overflow-hidden rounded-lg border-emerald-100 bg-white/90 shadow-sm 
                    xs:gap-6 xs:rounded-xl sm:gap-8 lg:flex-row lg:items-stretch lg:gap-8 lg:p-8 xs:p-6 p-5"
                >
                    {/* col 1  */}
                    <section className="hidden w-full max-w-[420px] shrink-0 border-b border-layout-separator pb-6 lg:block lg:border-b-0 lg:border-r lg:pb-0 lg:pr-6">
                        <div className="flex flex-col gap-6 sm:gap-8">
                            <div>
                                ...
                                <h1 className="text-xl font-semibold capitalize tracking-tighter text-gray-900 xs:text-[22px] sm:text-2xl">
                    ...
                    <section className="flex min-h-0 min-w-0 w-full flex-1 flex-col lg:justify-center">
                        <h2 className="text-2xl font-semibold tracking-tight text-gray-900 sm:text-3xl pb-2">
                            Sign in
                        </h2>
                        ...
                        <form className="mt-6 space-y-4 sm:mt-7">
                            <div className="space-y-2">
                                <label htmlFor="login-email" className="text-xs font-semibold uppercase tracking-wide text-gray-700">
                                    Email
                                </label>
                                <Input
                                    id="login-email"
                            ...
                            <div className="space-y-2">
                                <label htmlFor="login-password" className="text-xs font-semibold uppercase tracking-wide text-gray-700">
                                    Password
                                </label>
                                <Input
                                    id="login-password"
